...
void preNtDeviceIoControlFile(CPUX86State *env, void* user_data)
{
    ...
    pControlData = (PNtDeviceIoControlFileData)g_malloc(sizeof(NtDeviceIoControlFileData));
    if(pControlData)
    {
...
void postNtDeviceIoControlFile(CPUX86State *env, void* user_data)
{
    ...
    case AFD_RECV_DATAGRAM:
        ...
        {
            pWaitData = (PNtWaitForSingleObjectData)g_malloc(sizeof(NtWaitForSingleObjectData));
            if(!pWaitData)
            {
